...
- [ ] **Конфиги на исходном сервере совпадают с git (нет drift'а).** Для каждого
      ...
      потеряется. Боевой кейс bronto 2026-07-09: nginx-правки (`/comics/`, `/sw.js`,
...
- [ ] **Файловая статика nginx учтена в плане переноса.** Compose/volumes покрывают не всё:
      ...
      Боевой кейс bronto 2026-07-09: статичный комикс-ридер `/comics/` (23 МБ на диске) не
...
6. **Зеркало на старом nginx (канон для сервисов с записью в БД).** Сразу после smoke-test
   ...
   скорости propagation. Боевой кейс bronto 2026-07-09: простой 8,5 мин вместо часа ожидания
...
клиентской обвязке (боевой кейс bronto 2026-07-09: ТРИ ssh-туннеля Мака + MCP-сервер +
