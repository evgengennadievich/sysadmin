...
- **Ориентировка, а не доказательство.** Дайджест собирается на сервере по расписанию,
  поэтому у него две даты: когда собран на сервере и когда я его забрал. Обе указаны.
